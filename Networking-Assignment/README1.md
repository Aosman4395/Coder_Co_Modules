...
Completing this assignment also strengthened my ability to troubleshoot real-world issues from SSH access and NACL restrictions to DNS propagation and web server configuration.
